...
public enum Status {
     ...
     * {@link Status.Series#INFORMATIONAL}.
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link Status.Series#REDIRECTION}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     * @since 4.0
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link Status.Series#CLIENT_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     * @since 4.0
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link Status.Series#SERVER_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     * @since 4.0
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link Status.Series#CLIENT_ERROR} or
     * {@link Status.Series#SERVER_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     ...
     * <p>Retrievable via {@link Status#series()}.
     */
    public enum Series {
         ...
         */
        public static Series valueOf(Status status) {
